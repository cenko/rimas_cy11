...
% LANGUAGE:	LaTeX
% PURPOSE:	Swift Scientific Justification Proposal Template
% AUTHOR:	Stefan Immler, Swift Science Center (stefan.immler@nasa.gov)
% CREATED:	2008-10-01
% MODIFIED:	2011-09-01
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\includegraphics[width=0.38\textwidth]{090423.pdf}
\hspace{0.5cm}
...
\includegraphics[width=0.55\textwidth]{130606A.pdf}
}
\end{center}
...
% un-comment the following line to include your fig1a.ps postscript file:
%\psfig{figure=fig1a.ps,height=4.0cm,width=8.0cm,angle=0}
\includegraphics[width=0.50\textwidth]{rimasf1.pdf}
\hspace{0.5cm}
% un-comment the following line to include your fig1b.ps postscript file:
%\psfig{figure=fig1b.ps,height=4.0cm,width=7.0cm,angle=0}
\includegraphics[width=0.50\textwidth]{RIMAS_selslides3.pdf}
}
\end{center}
\caption{\footnotesize
...
% un-comment the following line to include your fig1b.ps postscript file:
%\psfig{figure=fig1b.ps,height=4.0cm,width=7.0cm,angle=0}
\includegraphics[width=1.0\textwidth]{xdisperse.pdf}
}
\end{center}
\caption{\footnotesize
...
\noindent {\bf 4. Report on Previous Swift and Related Programs}
\smallskip\\
...
\noindent {\bf 5. NASA Strategic Objectives}
\smallskip\\
...
\noindent {\bf 6. Applicant's Most Relevant Publications}
\smallskip\\
{\footnotesize
